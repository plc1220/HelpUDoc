...
def scan_recalculated_workbook(filename):
...
def recalc(filename, timeout=30):
    ...
    try:
        result = scan_recalculated_workbook(output_path)
        result["output"] = "outputs/recalculated.xlsx"
        return result
...
def main():
    ...
    (Path("outputs") / "recalc.json").write_text(json.dumps(result, indent=2))
