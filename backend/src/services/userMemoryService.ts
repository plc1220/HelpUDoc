...
export class UserMemoryService {
  ...
  async getMemoryView(userId: string, workspaceId?: string): Promise<UserMemoryView> {
    ...
    const paths = {
      ...
      globalSkillRouting: buildUserMemoryPath('global', 'skill-routing'),
      ...
      workspaceSkillRouting: workspaceId ? buildUserMemoryPath('workspace', 'skill-routing', workspaceId) : null,
    };
    ...
    const [
      ...
      getInternalMemoryFile(paths.globalSkillRouting, { authToken: token }),
      ...
      paths.workspaceContext
        ...
        : Promise.resolve({ path: '', exists: false, content: '' }),
      paths.workspaceSkillRouting
        ? getInternalMemoryFile(paths.workspaceSkillRouting, { authToken: token })
        : Promise.resolve({ path: '', exists: false, content: '' }),
    ]);
    ...
    return {
      ...
      globalSkillRouting: globalSkillRouting.content || '',
      workspacePreferences: workspacePreferences.content || '',
      workspaceContext: workspaceContext.content || '',
      workspaceSkillRouting: workspaceSkillRouting.content || '',
    };
  }
