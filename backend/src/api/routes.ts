...
export default function(
  ...
  const fileStatusService = new FileStatusService(dbService, workspaceService);
  ...
  router.use('/workspaces/:workspaceId/files', fileRoutes(fileService, workspaceService, googleOAuthService, fileStatusService));
