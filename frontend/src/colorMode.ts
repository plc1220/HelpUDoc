...
export const APP_COLOR_MODE_CHANGE_EVENT = 'helpudoc-color-mode-change';
...
export const applyColorModeToDocument = (mode: PaletteMode) => {
  ...
  if (typeof window !== 'undefined') {
    ...
    window.dispatchEvent(new CustomEvent<PaletteMode>(APP_COLOR_MODE_CHANGE_EVENT, { detail: mode }));
  }
};
