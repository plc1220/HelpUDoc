...
const SECTION_META: Array<{
  ...
  {
    key: 'globalSkillRouting',
    title: 'Global skill routing',
    hint: 'Hints for choosing installed skills across all workspaces.',
    scope: 'global',
  ...
  {
    key: 'workspaceSkillRouting',
    title: 'Workspace skill routing',
    hint: 'Workspace-specific skill selection hints (isolated per workspace).',
    scope: 'workspace',
    section: 'skill-routing',
  },
] as const;
            ...
            {SECTION_META.map((section) => (
              <div key={section.key} className={`rounded-2xl border px-4 py-4 ${
                ...
                <textarea
                  ...
                  rows={
                    section.key.toLowerCase().includes('context') || section.section === 'skill-routing' ? 6 : 4
                  }
